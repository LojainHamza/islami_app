class SuraModel {
  ...
  void add() {
    // for (int i = 0; i < suraArabicNameList.length; i++) {
    //   String data = suraArabicNameList[i];
    // }
    // for(String data in suraArabicNameList){
    //
    // }
  }
